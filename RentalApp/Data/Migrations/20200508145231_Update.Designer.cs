...
namespace RentalApp.Data.Migrations
{
    ...
    [Migration("20200508145231_Update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentalApp.Models.Genre", b =>
                {
                    b.Property<byte>("Id");
            ...
            modelBuilder.Entity("RentalApp.Models.MembershipType", b =>
                {
                    b.Property<byte>("Id");
            ...
            modelBuilder.Entity("RentalApp.Models.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RentalApp.Models.Customer", b =>
                {
                    b.HasOne("RentalApp.Models.MembershipType", "MembershipType")
                        .WithMany()
            ...
            modelBuilder.Entity("RentalApp.Models.Movie", b =>
                {
                    b.HasOne("RentalApp.Models.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("RentalApp.Models.Rental", b =>
                {
                    b.HasOne("RentalApp.Models.Customer", "CustomerId")
                        .WithMany()
                        .HasForeignKey("CustomerIdId");

                    b.HasOne("RentalApp.Models.Movie", "MovieId")
                        .WithMany()
